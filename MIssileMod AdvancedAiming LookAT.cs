                ...
                if (发射 == false)
                {
                    ...
                    if (Input.GetKey(key2))
                    {
                        if (currentTarget != null)
                        {
                            ...
                            Ray 阻碍检测ray = new Ray(this.transform.position, currentTarget.transform.position);
                    ...
                    if (mode == 1) {
                            if (弹道高度 != 0 && !转为俯冲姿态)//保持飞行
                            {
                                ...
                                this.rigidbody.AddForce(new Vector3(0, (this.transform.position.y - 弹道高度) / 300, 0));
                                ...
                                do {
                                    RaycastHit hitt3;
                                    Ray 检测ray = new Ray(new Vector3(this.transform.position.x, 弹道高度, this.transform.position.z), transform.InverseTransformDirection(currentTarget.transform.position));
                    ...
                    {//攻顶模式
                        ...
                        if (!转为俯冲姿态 && this.transform.position.y > currentTarget.transform.position.y + 100)
                        {
                            转为俯冲姿态 = true;
                            ...
                            if (Vector3.Distance(transform.position, currentTarget.transform.position) <= 5f) { 炸 = true; }
